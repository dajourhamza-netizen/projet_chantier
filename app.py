...
import streamlit as st
from streamlit_option_menu import option_menu  # Importation du menu moderne
...
# ==========================================
# 2. INJECTION DU CSS (Style personnalisé)
# ==========================================
hide_st_style = """
    <style>
    /* Masquer le menu par défaut, le footer et le header de Streamlit */
    #MainMenu {visibility: hidden;}
    footer {visibility: hidden;}
    header {visibility: hidden;}
    
    /* Moderniser les boutons de l'application */
    .stButton>button {
        border-radius: 8px;
...
# ==========================================
# 3. BARRE DE NAVIGATION MODERNE
# ==========================================
# Ce menu horizontal vient remplacer les onglets ou les radio buttons classiques
selected = option_menu(
    menu_title=None,  # Désactiver le titre pour garder un style épuré
    options=["Registre", "Nouveau Contrôle", "Historique", "Paramètres"],
    icons=["table", "plus-square", "clock-history", "gear"],  # Nom des icônes Bootstrap
    default_index=0,
...
# ==========================================
# 4. REDIRECTION ET CONTENU DES PAGES
# ==========================================
if selected == "Registre":
    st.title("📋 Registre des Chantiers")
    # Collez ici le code d'affichage de votre tableau principal / Google Sheets
    
elif selected == "Nouveau Contrôle":
    st.title("➕ Ajouter une nouvelle entrée")
    # Collez ici votre formulaire de saisie / génération Word

elif selected == "Historique":
    st.title("📜 Historique")
    # Collez ici le code de votre historique de connexion

elif selected == "Paramètres":
    st.title("⚙️ Configuration")
    # Collez ici la gestion des utilisateurs / paramètres
# ==========================================
